...
<%--        </tr>--%>
<%--        <tr>--%>
<%--&lt;%&ndash;            <td colspan="2" align="center" ><input type="submit" /></td>&ndash;%&gt;--%>
<%--            <td colspan="2" align="center" ><input type="button" /></td>--%>
<%--        </tr>--%>
<%--    </table>--%>
<%--</form>--%>
<form id="send-box">
    <table>
        ...
        <tr>
            ...
            <td><button type="button" onclick="send()">发送</button></td>
        </tr>
    </table>
</form>
